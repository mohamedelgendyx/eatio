...
class HomeObject_1(GameObject):
    ...
    def __init__(self, posX, posY, posZ, scaleX=2.5, scaleY=1.5, scaleZ=2, rotY=0, r1=1, g1=0.2, b1=0.6, r2=1, g2=0.7, b2=1, al=1):
    ...
    def draw(self):
        ...
        self.block(.25, 0.25, 0.25, 0, 2.4, 0, 1.1, .1, 1.1, 2,a=self.a)  # roof
        self.block(.25, .25, .25, -.65, 1.3+.2, -1.0001, .5, .5, 0, 1,a=self.a)  # window
        self.block(.25, .25, .25, .65, 1.3+.2, -1.0001, .5, .5, 0, 1,a=self.a)
        self.block(.25, .25, .25, 0, 0.45+.2, -1.0001, .45, 1.3, 0, 1,a=self.a)  # door
...
class HomeObject_2(GameObject):
    ...
    def draw(self):
        self.block(1, .2, 0, 0, 1.8, 0, 1, .5, .5, 7,a=self.a)
        self.block(1, .35, 0, 0, 8.57+1.8, 0, 1, 2, .5, 7,a=self.a)
        self.block(.25, .25, .25, 0, 16.1+1.8, 0, 1.1, .1, .55, 7,a=self.a)  # roof
        self.block(1, 1, 1, -3.3, 8.57+1.8, -1.6, 1, 28, 1, .5,a=self.a)  # Right white part
        ...
        for i in np.arange(2.3, 13.8, 2.3):  # windows
            ...
            self.block(.25, .25, .25, 2.28, 2+1.8, -1.79, 1, 2, 0, 1,a=self.a)
            self.block(.25, .25, .25, 2.28, 2+1.8 + i, -1.79, 1, 2, 0, 1,a=self.a)
...
class HomeObject_4(GameObject):
    ...
    def draw(self):
        self.block(self.r, self.g, self.b, 0, 3.75, 0, 1, 1.5, 1, 5,a=self.a)
        self.block(.25, .25, .25, 0, 3.8+3.75, 0, .9, 0, .9, 5,a=self.a)
        self.block(1, 1, 1, 0, 3.76+3.75, -2.75, 1, 0, .3, 5,a=self.a)
        self.block(1, 1, 1, 0, 3.75, -.6, 1.2, .3, 1.2, 5,a=self.a)
        self.block(0.25, .25, 0.25, -1.1, 2.2+3.75, -2.6, 1.2, 1.4, 0, 1.5,a=self.a)
        self.block(0.25, .25, 0.25, 1.1, 2.2+3.75, -2.6, 1.2, 1.5, 0, 1.5,a=self.a)
...
class HomeObject_5(GameObject):
    ...
    def draw(self):
        ...
        self.block(0.9, 0.1, 0.4, -1.2, 2.2, 2.1, .5, .9, 0, 2,a=self.a)
        self.block(0.9, 0.1, 0.4, 0, 2.2, 2.1, .5, .9, 0, 2,a=self.a)
        self.block(0.9, 0.1, 0.4, 1.2, 2.2, 2.1, .5, .9, 0, 2,a=self.a)
        self.block(.3, .3, .6, -1.2, -1.6, 2.1, .5, .8, 0, 2,a=self.a)
        self.block(.3, .3, .6, 1.2, -1.6, 2.1, .5, .8, 0, 2,a=self.a)
        self.block(0, 0, 0, 0, -2.4, 2.1, .5, 1.1, 0, 2,a=self.a)
        self.block(0.3, 0.8, 1, 0, 4, 0, 4, .5, 4, 1,a=self.a)
        self.block(0, 0, .4, 2, 0, 0, .1, 2, 1, 4,a=self.a)
        self.block(0, 0, .4, -2, 0, 0, .1, 2, 1, 4,a=self.a)
